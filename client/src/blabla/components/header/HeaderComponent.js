...
function HeaderComponent() {
    ...
    switch (true) {
        ...
        case currentItem === SLUGS.contacts:
            title = 'Contacts';
            break;
        case currentItem === SLUGS.staffProfile:
            title = 'Staff Profile';
            break;
        ...
        <Row className={classes.container} vertical='center' horizontal='space-between'>
            ...
            <Row vertical='center'>
                ...
                <DropdownComponent
                    label={
                        <>
                            <span className={classes.name}>Basant Mounir</span>
                            <img
                                src='https://lh3.googleusercontent.com/a-/AOh14Gj43WnACEauUzP5IxS3ZyPaNO5CsVmPIZThR-ZKfAg=s48'
                                alt='avatar'
