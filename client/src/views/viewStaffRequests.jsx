...
import { Container, Jumbotron, Button, Table, Col, Form, Modal } from "react-bootstrap";
...
class ViewStaffRequests extends Component {
  ...
  componentDidMount() {
    console.log("getting")
    axios.get('http://localhost:4000/hod/viewStaff')
      .then(res => {
  ...
  render() {
    ...
    return (
      ...
      <Modal show={this.state.show} onHide={handleClose}>
        ...
        <Modal.Body><Form> <Form.Group controlId="formBasicEmail">
  ...
  <tbody>
    <tr>
      ...
      <td>Mark</td>
      <td>Otto</td>
      <td><Col><Button varient='success'>Accept</Button> <Button onClick={handleShow} variant='danger'>Reject</Button></Col></td>
    </tr>
    <tr>
      <td>2</td>
      <td>Jacob</td>
